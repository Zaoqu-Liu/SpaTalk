...
### A cell-cell communication inference approach for spatially resolved transcriptomic data (Optimized Version)

> **Note**: This is a modified version of the original SpaTalk package. For the original version, please visit [ZJUFanLab/SpaTalk](https://github.com/ZJUFanLab/SpaTalk).
...
# About
SpaTalk was originally developed by Xin Shao. This modified version is maintained by Zaoqu Liu (liuzaoqu@163.com).

For the original package, please contact Xin Shao at xin_shao@zju.edu.cn

**Original Citation**: Shao, X., et al. Knowledge-graph-based cell-cell communication inference for spatially resolved transcriptomic data with SpaTalk. Nat Commun 13, 4429 (2022). https://doi.org/10.1038/s41467-022-32111-8

**Original Repository**: https://github.com/ZJUFanLab/SpaTalk
